...
caffevis_caffe_root      = '/home/alien/caffe'

# Load model: caffenet-yos
# Path to caffe deploy prototxt file. Minibatch size should be 1.
#caffevis_deploy_prototxt = '/home/alien/deep-visualization-toolbox/models/caffenet-yos/caffenet-yos-deploy.prototxt'
caffevis_deploy_prototxt = '/home/alien/productos/network/deploy.prototxt'

# Path to network weights to load.
#caffevis_network_weights = '/home/alien/deep-visualization-toolbox/models/caffenet-yos/caffenet-yos-weights'
#caffevis_network_weights = '/home/alien/caffe/models/productos_caffenet/rate01/caffenet_train_iter_40000.caffemodel'
caffevis_network_weights = '/home/alien/caffe/models/productos_caffenet/caffenet_train_iter_40000.caffemodel'

# Other optional settings; see complete documentation for each in settings.py.
#caffevis_data_mean       = '/home/alien/caffe-productos/mean.binaryproto'
caffevis_labels          = '/home/alien/productos/network/labels.txt'
caffevis_label_layers    = ('fc8', 'prob')
caffevis_prob_layer      = 'prob'
#caffevis_unit_jpg_dir    = '/home/alien/deep-visualization-toolbox/models/caffenet-yos/unit_jpg_vis'
